...
### [ ] 2. "Custom Validation Rules" is a dead end on both ends — needs a design decision first
...
### [ ] 4. Mailchimp integration is advertised in `readme.txt` but is fully unreachable
