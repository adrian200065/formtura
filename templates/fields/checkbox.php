...
<div class="<?php echo esc_attr( fta_get_field_wrapper_class( $field, 'fta-field-checkbox' ) ); ?>"<?php echo fta_get_field_wrapper_data( $field ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
