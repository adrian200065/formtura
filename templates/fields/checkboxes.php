<?php
/**
 * Checkboxes Field Template
 *
 * Template for a multi-answer checkbox group.
 *
 * @package Formtura
 * @since 1.0.3
 *
...
<div class="<?php echo esc_attr( fta_get_field_wrapper_class( $field, 'fta-field-checkboxes' ) ); ?>"<?php echo fta_get_field_wrapper_data( $field ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
