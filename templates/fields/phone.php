...
<div class="<?php echo esc_attr( fta_get_field_wrapper_class( $field, 'fta-field-phone' ) ); ?>"<?php echo fta_get_field_wrapper_data( $field ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	...
	<input
		...
		value=""
		<?php echo ! empty( $field['enableAutocomplete'] ) ? 'autocomplete="tel"' : ''; ?>
